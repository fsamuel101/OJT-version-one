...
<nav class="header-main">
    ...
    <div class="contact-details">
        ...
        <div class="email-ad contact-container">
            ...
            <div class="margin-1">
                <p>Email Address</p>
                <p><a class="green" style="text-decoration: none;"
                        href="mailto:plsp.official@plsp.edu.ph">southlakesintegratedschool@yahoo.com.ph</a></p>
            </div>
        </div>

        <div class="email-ad contact-container">
            <img src="images/mobile.png" alt="" height="45px;">
            <div class="margin-1">
                <p>Mobile Number</p>
                <p>+63998-979-1547</p>
            </div>
        ...
        <div class="phone-number contact-container">
            <img src="images/Telephone.png" alt="" height="45px;">
            <div class="margin-1">
                <p>Phone Number</p>
                <p>(049)5603268</p>
            </div>
